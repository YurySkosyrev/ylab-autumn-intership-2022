...
public class UserRepositoryTest {
    ...
    void updatePerson_thenAssertDmlCount() {
        ...
        person.setAge(40);
        person.setTitle("reader");
        person.setFullName("Yuriy Lupkin");
        ...
        assertThat(result.getFullName()).isEqualTo("Yuriy Lupkin");
        assertSelectCount(1);
        assertInsertCount(0);
        assertUpdateCount(0);
        assertDeleteCount(0);
    ...
    @DisplayName("Удалить юзера. Число delete должно равняться 3")
    @Test
    @Rollback
    @Sql({"classpath:sql/1_clear_schema.sql",
            "classpath:sql/2_insert_person_data.sql",
    ...
    // * failed
    @DisplayName("Удалить юзера FailTest. Число delete должно равняться 3")
    @Test
    @Rollback
    @Sql({"classpath:sql/1_clear_schema.sql",
            "classpath:sql/2_insert_person_data.sql",
    ...
    void GetPersonFail_thenAssertDmlCount() {
        ...
        //Then
        assertThatThrownBy(() -> getPerson.getAge())
